...
- [LIBERO / SmolVLA 复现与 MEA 接入](libero_smolvla_reproduction_zh.md)：独立 environment/policy smoke、固定环境与最小迁移协议。
...
- [当前小型论文协议结果](../experiments/paper/results/batch24_claim_closure/summary.json)：
