...
EXPERIMENT CANDIDATE:
{
  ...
  "candidate_id": "dynamic.press.stapler.spatial.robustness.stapler.translation.y.axis.left.tcp.terminal.proximity.under.a.bounded.0.02.m.simulator.y.translation.of.the.stapler.the.policy.will.fail.to.satisfy.the.combined.condition.of.the.official.press.stapler.goal.and.terminal.left.tcp.to.stapler.distance.at.most.0.10.m.b9e4f2e3ac76",
  "checker_need": {
    "description": "Return true only when the official core predicate and the added terminal-state relation both hold: official goal AND terminal Euclidean distance between the left TCP and the stapler is less than or equal to 0.10 m.",
    "kind": "generate",
    "reuse_first": true
  },
  "evaluation_intent": {
    "hypothesis": "Under a bounded +0.02 m simulator-y translation of the stapler, the policy will fail to satisfy the combined condition of the official press_stapler goal and terminal left-TCP-to-stapler distance at most 0.10 m.",
    "intent_id": "intent.737f0a4decaf06af",
    "original_concern": "spatial_robustness.stapler_translation_y_axis.left_tcp_terminal_proximity",
    "preserved_conditions": [
      "task identity",
      "policy checkpoint",
      "official core predicate as a required conjunct"
    ],
    "requested_change": "Translate the stapler from its official baseline position by +0.02 m along the simulator y-axis.",
    "required_observation": "Return true only when the official core predicate and the added terminal-state relation both hold: official goal AND terminal Euclidean distance between the left TCP and the stapler is less than or equal to 0.10 m. Report the terminal Euclidean distance in meters between the left TCP and the stapler as the primary scalar observation.",
    "schema_version": 1,
    "source_query": "Does there exist a bounded simulator-state concern, distinct from the unchanged official press_stapler control, that exposes a policy weakness? Observe one official control, then let the Plan Agent invent the most informative executable concern from evidence; I provide no aspect, object, axis, magnitude, relation, threshold, template, checker code, or metric. For every generated experimental round, generate an experimental checker that preserves the official success predicate as a required conjunct and adds one directly observable current-state relation. Generate a separate scalar Rule Tool that diagnoses the concern without deciding success. If a successful generated round and its live scalar show a comfortable margin, use that evidence to choose a different semantic concern instead of merely amplifying the same factor. The Plan Agent should propose stop as soon as completed evidence supports a bounded failure witness; otherwise report only the tested limited scope."
  },
  "intent_alignment": {
  ...
  "rule_tool_need": {
    "description": "Report the terminal Euclidean distance in meters between the left TCP and the stapler as the primary scalar observation.",
    "kind": "measure",
    "reuse_first": true
  },
  "scene_need": {
    "description": "Construct or adapt the scene by translating the stapler from its official baseline position by +0.02 m along the simulator y-axis. Preserve unchanged: task identity; policy checkpoint; official core predicate as a required conjunct.",
    "kind": "adapt",
    "reuse_first": true
  },
  "schema_version": 2,
  "semantic_concern": "spatial_robustness.stapler_translation_y_axis.left_tcp_terminal_proximity: Under a bounded +0.02 m simulator-y translation of the stapler, the policy will fail to satisfy the combined condition of the official press_stapler goal and terminal left-TCP-to-stapler distance at most 0.10 m.",
  "source_query": "Does there exist a bounded simulator-state concern, distinct from the unchanged official press_stapler control, that exposes a policy weakness? Observe one official control, then let the Plan Agent invent the most informative executable concern from evidence; I provide no aspect, object, axis, magnitude, relation, threshold, template, checker code, or metric. For every generated experimental round, generate an experimental checker that preserves the official success predicate as a required conjunct and adds one directly observable current-state relation. Generate a separate scalar Rule Tool that diagnoses the concern without deciding success. If a successful generated round and its live scalar show a comfortable margin, use that evidence to choose a different semantic concern instead of merely amplifying the same factor. The Plan Agent should propose stop as soon as completed evidence supports a bounded failure witness; otherwise report only the tested limited scope.",
  "tool_need": {
    "description": "Report the terminal Euclidean distance in meters between the left TCP and the stapler as the primary scalar observation.",
    "kind": "measure",
