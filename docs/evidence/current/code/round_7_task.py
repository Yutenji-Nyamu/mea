...
class press_stapler(_official_task_module.press_stapler):
    def load_actors(self):
        ...
        stapler_position = rand_pos.p.copy()
        stapler_position[2] += 0.030
        rand_pos = sapien.Pose(stapler_position, rand_pos.q)
    ...
    def check_success(self):
        ...
        return self.mea_official_check_success() and np.linalg.norm(left_tcp_position - stapler_position) <= 0.080
