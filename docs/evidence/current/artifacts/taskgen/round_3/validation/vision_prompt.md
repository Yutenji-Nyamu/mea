...
SEMANTIC CONCERN:
task_execution.object_instance_variation: The ACT policy fails to achieve success when the bell's object instance is perturbed within allowable bounds.

REQUESTED SCENE NEED:
Introduce a bounded variation in the bell's object instance. Preserve unchanged: task identity; policy checkpoint.
