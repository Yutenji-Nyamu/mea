...
def main() -> None:
    ...
    run_legacy_catalog_agent(
        ...
        adaptive_step_agent=adaptive_step_agent,
        planning_context=planning_context,
        ...
        history_retrieval=history_retrieval,
        history_context_count=len(history_context),
        apply_bounded_round_proposal=apply_bounded_round_proposal,
        adjudicate_bounded_transition=adjudicate_bounded_transition,
        persist_adaptive_step_selection=persist_adaptive_step_selection,
    )
    return
