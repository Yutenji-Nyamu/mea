...
CLAIMS: tuple[ClaimSpec, ...] = (
    ClaimSpec(
        1,
        "plan_evidence_loop",
        "Evidence-driven Plan Agent transition",
        ...
        (
            ...
            CodeRequirement(
                ...
                "symbol",
                "mea/planner/session.py",
                "BoundTaskPlanSession.directive",
            ),
            CodeRequirement(
                "session_adjudicate",
                "symbol",
                "mea/planner/session.py",
                "BoundTaskPlanSession.adjudicate",
            ),
        ),
    ),
    ClaimSpec(
        ...
        "Observation-conditioned Task/Tool Proposal every round",
        "Figs. 2-4",
        (
            CodeRequirement(
            ...
            CodeRequirement(
                ...
                value="adjudicate_bounded_transition",
            ),
        ),
    ),
    ClaimSpec(
