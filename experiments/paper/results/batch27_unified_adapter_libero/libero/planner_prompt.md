...
POLICY AND SIMULATOR CAPABILITIES:
{
  ...
  "simulator_card": {
    "benchmark": "LIBERO",
    "suite": "libero_object",
    "official_control": "explicitly bound task 0 at the same initial simulator state",
...
[
  {
    ...
    "outcome": "success",
    "evidence_summary": "Official libero_object/task0 live rollout success=True; reward_sum=1.0; steps=135.",
    "limitations": [
      "N=1 fixed seed",
