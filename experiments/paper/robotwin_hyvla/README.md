...
This proves one runnable generalist-policy adapter and one official task success. It
does **not** establish 50-task success, a policy ranking, or a complete
ManipEvalAgent evaluation.
...
logic. A full production live round still requires server-side acceptance after
