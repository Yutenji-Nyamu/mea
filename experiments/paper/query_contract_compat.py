"""Cold compatibility copy of the retired formal Query-contract protocol.

This module exists only so frozen paper experiments remain readable. Ordinary
MEA production uses ``mea.planner.runtime_limits`` and lets the Plan Agent
author continue/stop decisions from evidence.
