"""Cold hash-pinned evidence preregistration for paper experiments.
...
from mea.toolkit.profiles import load_telemetry_profile
...
def prepare_evidence_manifest(
    ...
    manifest: dict[str, Any] = {
        ...
        "telemetry": {
            ...
            "profile": telemetry,
            "profile_sha256": canonical_sha256(telemetry),
        },
        "sample_schedule": {
...
def validate_evidence_manifest(
    ...
    if telemetry["profile_sha256"] != canonical_sha256(trusted_profile):
